...
Theta1_grad = Theta1;
Theta1_grad(1:end,1) = 0;
Theta2_grad = Theta2;
Theta2_grad(1:end,1) = 0;

J = J + lambda/(2*m) * (sum(sum(Theta1_grad.*Theta1_grad)) + sum(sum(Theta2_grad.*Theta2_grad)));

%Back propagation implementation
delta1 = zeros(hidden_layer_size, input_layer_size+1);
delta2 = zeros(num_labels, hidden_layer_size+1);
de12 = zeros(hidden_layer_size, 1);
...
D1 = 1/m * delta1 + lambda/m * Theta1_grad;
D2 = 1/m * delta2 + lambda/m * Theta2_grad;
